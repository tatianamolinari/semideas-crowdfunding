...
class DisplayContent extends React.Component {
  ...
  render() {
    ...
    return (  <div className="campaign-info" id="general_data_container">            
                ...
                <hr/>
                <div data-testid="goal"> Para que esta campaña comience se deben recaudar { this.props.data.goal } wei o más. </div>
                <div data-testid="balance"> Contriobuciones totales: { this.props.data.balance } wei. </div>
                <div data-testid="minimunContribution"> La contribución mínima es de { this.props.data.minimunContribution } wei.</div> 
                <div data-testid="owner"> Autor: { this.props.data.owner }. </div>   
                <div data-testid="membersCount"> Cantidad de miembros contribuyentes: { this.props.data.membersCount }. </div>
